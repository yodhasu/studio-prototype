    ...
    <div class="mx-auto max-w-7xl space-y-8">
      <header class="flex items-end justify-between">
        <div>
          ...
          <p class="mt-1 text-sm text-muted">
            Configure preferences and studio settings.
          </p>
        </div>
        <button
      ...
      <div class="flex gap-8">
        ...
        <section class="flex-1 dashboard-panel min-h-[400px]">
          <h3 class="text-lg font-bold text-text mb-6 border-b border-border/50 pb-4">
            {{ activeTab }}
          </h3>
          ...
          <div
            v-else
            class="flex flex-col items-center justify-center h-48 text-muted text-sm italic"
          >
